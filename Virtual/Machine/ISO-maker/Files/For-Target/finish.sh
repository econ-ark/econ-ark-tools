...
# mkdir -p /EFI/BOOT/
[[ -e /EFI/BOOT/ ]] && cp /var/local/Econ-ARK.disk_label    /EFI/BOOT/.disk_label
[[ -e /EFI/BOOT/ ]] && cp /var/local/Econ-ARK.disk_label_2x /EFI/BOOT/.disk_label2x
[[ -e /EFI/BOOT/ ]] && echo 'Econ-ARK'    >                 /EFI/BOOT/.disk_label_contentDetails
...
# sudo newgrp lpadmin
# sudo usermod -aG lpadmin econ-ark
# sudo usermod -aG sambashare econ-ark
