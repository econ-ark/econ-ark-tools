...
sudo /bin/sed -i 's|default live|default auto-install\nlabel auto-install\n  menu label ^Autoinstall Econ-ARK Xubuntu Live Server\n  kernel /casper/vmlinuz\n  append boot=casper file=/cdrom/preseed/econ-ark.seed vga=788 initrd=/casper/initrd auto=true priority=critical locale=en_us quiet ---|'     $iso_make/iso_new/isolinux/txt.cfg
