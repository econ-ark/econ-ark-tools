...
if [ "$version" == "base" ]; then
    ...
    sudo /bin/sed -i 's|set timeout=30|set timeout=10\nmenuentry "Autoinstall Econ-ARK Xubuntu" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us DEBCONF_DEBUG=5 nolapic ---\n	initrd	/install/initrd.gz\n}\nmenuentry "Most Macs" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    nolapic ---\n	initrd	/install/initrd.gz\n}\nmenuentry "MacBookPro9,1-Mid-2012 (noapic-still might not work)" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us noapic  ---\n	initrd	/install/initrd.gz\n}\nsubmenu "Boot debug options ..." {\nmenuentry "acpi=off" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    acpi=off        ---\n	initrd	/install/initrd.gz\n}\nmenuentry "nolapic noapic irqpoll" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    noapic irqpoll       ---\n	initrd	/install/initrd.gz\n}\nmenuentry "noapic" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    noapic        ---\n	initrd	/install/initrd.gz\n}\nmenuentry "acpi=ht" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    acpi=ht        ---\n	initrd	/install/initrd.gz\n}\nmenuentry "acpi_osi=Linux" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    cpi_osi=Linux ---\n	initrd	/install/initrd.gz\n}\nmenuentry "pci=noacpi" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/ecopn-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    pci=noacpi        ---\n	initrd	/install/initrd.gz\n}\nmenuentry "pci=noirq" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    pci=noirq        ---\n	initrd	/install/initrd.gz\n}\nmenuentry "apci=noirq" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    acpi=noacpi        ---\n	initrd	/install/initrd.gz\n}\nmenuentry "pnpacpi=off" {\n	set gfxpayload=keep\n	linux	/install/vmlinuz keyboard-configuration/layoutcode=us keyboard-configuration/xkb-keymap=us languagechooser/language-name=English countrychooser/shortlist=US  boot=casper file=/cdrom/preseed/econ-ark.seed auto=true priority=critical locale=en_US.UTF-8 console-setup/layoutcode=us                    pnpacpi=off        ---\n	initrd	/install/initrd.gz\n}\n}|g' $iso_make/iso_new/boot/grub/grub.cfg
