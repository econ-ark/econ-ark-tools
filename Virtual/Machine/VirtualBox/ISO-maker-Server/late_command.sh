...
curl -L -o /var/local/finish.sh https://raw.githubusercontent.com/econ-ark/econ-ark-tools/master/Virtual/Machine/VirtualBox/ISO-maker-Server/finish-MAX-Extras.sh 
...
chmod +x /var/local/start.sh /var/local/finish.sh /etc/rc.local 
